...
export NEXT_PUBLIC_URL="https://${NEXT_PUBLIC_SHOP_NAME}.${NEXT_PUBLIC_ROOT_DOMAIN}"
...
export NEXT_PUBLIC_CMS_BASE_URL="https://${NEXT_PUBLIC_SHOP_NAME}.${NEXT_PUBLIC_ROOT_DOMAIN}"
...
cat << EOF > .env
export SHOP_NAME="${NEXT_PUBLIC_SHOP_NAME}"
export ROOT_DOMAIN="${NEXT_PUBLIC_ROOT_DOMAIN}"
