export function Return() {
  return (
    <div>
      <h1 className="text-2xl font-medium text-[#101828]">İade Politikası</h1>
      <div className="mt-4 space-y-1 text-[#475467]">
        <p className="pt-2 font-medium">Genel bilgi </p>
        <p>
          Bu çerez politikası, W3yz ve ilgili şirketinin www.w3yz.com da, web
          sitelerimizde, mobil uygulamamızda, çevrimiçi ürünümüzde ve w3yz in
          işlettiği ve bu politikaya bağlantı veren diğer web sitelerinde
          çerezleri ve ilgili teknolojileri nasıl kullandığını açıklar.
        </p>
        <p>
          Biz, Şirket Adı, olarak güvenliğinize önem veriyor ve bu Çerez
        ...
        <p className="pt-2 font-medium">Çerez Nedir?</p>
        <p>
          ...
          gerekmektedir. Bizler de siz sevgili ziyaretçilerimizin, web
          sitemizden en verimli şekilde yararlanabilmelerini ve siz sevgili
          ziyaretçilerimizin kullanıcı deneyimlerinin geliştirilebilmesini
          sağlamak adına, çeşitli çerezler kullanmaktayız.
        </p>
        <p className="pt-2 font-medium">1. Zorunlu Çerezler</p>
        <p>
          ...
          sitesi bu çerezler olmadan düzgün çalışmaz. Siteyi kullandığınız
          sürece bu çerezler kabul edilmiş sayılacaktır.
        </p>
        <p className="pt-2 font-medium">2. Performans Çerezleri </p>
        <p>
        ...
        <p className="pt-2 font-medium">3. Fonksiyonel Çerezler </p>
        <p>
        ...
        <p className="pt-2 font-medium">4. Reklam Çerezleri </p>
        <p>
        ...
        <p>
          Çerezler İle İşlenen Kişisel Veriler Nelerdir? Kimlik (isim, soy isim,
          doğum tarihi vb.) ve iletişim (adres, e-posta adresi, telefon, IP,
          konum vb.) bilgileriniz tarafımızca, çerezler (cookies) vasıtasıyla,
          otomatik veya otomatik olmayan yöntemlerle ve bazen de analitik
          sağlayıcılar, reklam ağları, arama bilgi sağlayıcıları, teknoloji
        ...
        <p className="pt-2 font-medium">Çerezler Nasıl Yönetilmektedir?</p>
        <p>
